...
mod mul {
    ...
    impl<const A: u8, B: PrimIntTrait + BrandedTrait + SignIntrospectionTrait> MulTrait for Q<A, B> where Precision<A>: PrecisionTrait {
        ...
        fn mul(self, rhs: Self) -> Self::Output {
            let x: &Self = &self;
            let y: &Self = &rhs;
            let data: _MulData<'_, A, B> = _MulData {
                x,
                y,
                u128_muldiv_algo: &(Self::_u128_newton_raphson_inverse_muldiv as _U128MuldivAlgo),
                i128_muldiv_algo: &(Self::_i128_newton_raphson_inverse_muldiv as _I128MuldivAlgo),  
            };
            Self::_mul(data)
        }
    }
...
mod fallback_mul {
    ...
    impl<const A: u8, B: PrimIntTrait + BrandedTrait + SignIntrospectionTrait> Q<A, B> where Precision<A>: PrecisionTrait {
        ...
        fn mul_with_fallack(self, rhs: Self) -> QTraitResult<Self> {
            let x: Self = self;
            let y: Self = rhs;
            let v: QTraitResult<Self> = x * y;
            if v.is_ok() {
                return v
            }
            let v: QTraitResult<Self> = x.bit_simulated_mul(y);
            if v.is_ok() {
                return v
            }
            x.quick_mul(y)
...
mod bit_simulated_mul {
    ...
    impl<const A: u8, B: PrimIntTrait + BrandedTrait + SignIntrospectionTrait> Q<A, B> where Precision<A>: PrecisionTrait, {
        ...
        pub fn bit_simulated_mul(self, rhs: Self) -> QTraitResult<Self> {
            let x: &Self = &self;
            let y: &Self = &rhs;
            let data: _MulData<'_, A, B> = _MulData {
                x,
                y,
                u128_muldiv_algo: &(Self::_u128_256_bit_simulated_muldiv as _U128MuldivAlgo),
                i128_muldiv_algo: &(Self::_i128_256_bit_simulated_muldiv as _I128MuldivAlgo),  
            };
            Self::_mul(data)
        }
    }
...
mod quick_mul {
    ...
    impl<const A: u8, B: PrimIntTrait + BrandedTrait + SignIntrospectionTrait> Q<A, B> where Precision<A>: PrecisionTrait, {
        ...
        pub fn quick_mul(self, rhs: Self) -> QTraitResult<Self> {
            let x: &Self = &self;
            let y: &Self = &rhs;
            let data: _MulData<'_, A, B> = _MulData {
                x,
                y,
                u128_muldiv_algo: &(Self::_u128_256_bit_simulated_muldiv as fn(u128, u128, u128) -> QTraitResult<u128>),
                i128_muldiv_algo: &(Self::_i128_256_bit_simulated_muldiv as fn(i128, i128, i128) -> QTraitResult<i128>),  
            };
            Self::_mul(data)
        }
    }
...
mod muldiv {
    ...
    impl<const A: u8, B: PrimIntTrait + BrandedTrait + SignIntrospectionTrait> Q<A, B> where Precision<A>: PrecisionTrait, {
        ...
        pub(super) fn _mul<'l1>(data: _MulData<'l1, A, B>) -> QTraitResult<Self> {
            let decimals: u32 = A.into();
        ...
        pub(super) fn _u128_muldiv(x: u128, y: u128, z: u128) -> QTraitResult<u128> {
            if z == 0u128 {
                return Err(QTraitError::DivisionByZero)
            }
        ...
        pub(super) fn _i128_muldiv(x: i128, y: i128, z: i128) -> QTraitResult<i128> {
            if z == 0 {
                return Err(QTraitError::DivisionByZero)
            }
        ...
        pub(super) fn _u128_256_bit_simulated_muldiv(x: u128, y: u128, z: u128) -> QTraitResult<u128> {
            if z == 0 {
                return Err(QTraitError::DivisionByZero)
            }
            let x_hi: u128 = x >> 64;
        ...
        pub(super) fn _i128_256_bit_simulated_muldiv(x: i128, y: i128, z: i128) -> QTraitResult<i128> {
            if z == 0 {
                return Err(QTraitError::DivisionByZero)
            }
            let sign: i128 = ((x ^ y ^ z) >> 127) & 1;
        ...
        pub(super) fn _u128_newton_raphson_inverse_muldiv(x: u128, y: u128, z: u128) -> QTraitResult<u128> {
            if z == 0 {
                return Err(QTraitError::DivisionByZero)
            }
            let (hi, lo) = {
    ...
    pub(super) fn _i128_newton_raphson_inverse_muldiv(x: i128, y: i128, z: i128) -> QTraitResult<i128> {
        if z == 0 {
            return Err(QTraitError::DivisionByZero)
        }
        let sign: i128 = ((x ^ y ^ z) >> 127) & 1;
    ...
    pub(super) struct _MulData<'l1, const A: u8, B: PrimIntTrait + BrandedTrait + SignIntrospectionTrait> where Precision<A>: PrecisionTrait, {
        pub x: &'l1 Q<A, B>,
        pub y: &'l1 Q<A, B>,
