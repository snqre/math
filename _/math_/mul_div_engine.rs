...
pub type Algo = (MulDivEngineU128Algo, MulDivEngineI128Algo);

pub type U128Algo = fn(u128, u128, u128) -> QTraitResult<u128>;

pub type I128Algo = fn(i128, i128, i128) -> QTraitResult<i128>;

pub struct Data<'a, const A: u8, B> 
    where
        B: PrimIntT,
        B: BrandedT,
        B: SignIntrospectionT,
        B: MaybeEncodeT,
        B: MaybeDecodeT,
        B: MaybeTypeInfoT,
        B: MaybeStorageLayoutT,
        Precision<A>: PrecisionT, {
    pub x: &'a Q<A, B>,
    pub y: &'a Q<A, B>,
...
impl MulDivEngine {
    ...
    pub fn cast<const A: u8, const B: u8, C, D>(&self, current: &Q<A, C>, algo: &MulDivEngineAlgo) -> QTraitResult<Q<B, C>> 
        where
            C: PrimIntTrait,
            C: BrandableT,
    ...
    pub fn mul<const A: u8, B>(&self, data: MulDivEngineData<'_, A, B>) -> QTraitResult<Q<A, B>> 
        where 
            B: PrimIntTrait,
            B: BrandableT,
    ...
    pub fn div<const A: u8, B>(&self, data: MulDivEngineData<'_, A, B>) -> QTraitResult<Q<A, B>> 
        where
            B: PrimIntTrait,
            B: BrandableT,
            B: SignIntrospectionTrait,
